<?php namespace App\Http\Controllers;
	...
	class AdminMasterunitdetailsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "masterunitdetails";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Units","name"=>"Units"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Units','name'=>'Units','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Waste Sub Category','name'=>'ID_PkWasteSCID','type'=>'select2','datatable'=>'masterwastesubcategories,SubCategoryName','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Units","name"=>"Units","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */
	    public function hook_before_delete($id) {
	        //Your code here
	    	DB::table('masterunitdetails')->where('id',$id)->update(['IsActive' => 0]);
	    }
